...
# Ubuntu 24.04 KVM image:
# https://cloud-images.ubuntu.com/jammy/20250725/jammy-server-cloudimg-amd64-disk-kvm.img
# https://cloud-images.ubuntu.com/minimal/releases/jammy/release-20250829/ubuntu-22.04-minimal-cloudimg-amd64.img
...
VM_QCOW_SRC=$(ls -1t ~/Downloads/bootable-images/kvm/*server-cloudimg*.img | head -1)
VM_PUB_KEY=$(cat ~/.ssh/dev.pub)
VM_SEED_DATA="${VM_SCRIPT_PATH}/cloud-init.${VM_NAME}"
VM_OS_VARIANT="ubuntu-stable-latest" # virt-install --osinfo list | grep ubuntu24
