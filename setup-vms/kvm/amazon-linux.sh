...
# https://cdn.amazonlinux.com/al2023/os-images/2023.8.20250915.0/kvm/al2023-kvm-2023.8.20250915.0-kernel-6.1-x86_64.xfs.gpt.qcow2
...
VM_QCOW_SRC=$(ls -1t ~/Downloads/bootable-images/kvm/al2023*.qcow2 | head -1)
